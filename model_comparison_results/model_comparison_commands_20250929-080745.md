...
Generated on: 2025-09-29T08:07:45.663836
...
python scripts/run_parallel_configs.py \
  ...
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-080745
cd ..
```
...
```bash
# Run gpt-4.1-mini with copy_folders.py --replace (2 variations)
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-080745 --output llama_foundation_model_backstory_gpt-4.1-mini_with_20250929-080745 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  --student-model gpt-4.1-mini \
  ...
  --num-variations 2 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_with_20250929-080745
cd ..
```
...
```bash
# Run llama_sft with copy_folders.py --replace (2 variations)
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-080745 --output llama_foundation_model_backstory_llama_sft_without_20250929-080745 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  ...
  --num-variations 2 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_sft_without_20250929-080745
cd ..
```
...
```bash
# Run llama_dpo with copy_folders.py --replace (2 variations)
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-080745 --output llama_foundation_model_backstory_llama_dpo_without_20250929-080745 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  ...
  --num-variations 2 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_dpo_without_20250929-080745
cd ..
```
...
- `model_comparison_results/llama_foundation_model_backstory_20250929-080745/`
