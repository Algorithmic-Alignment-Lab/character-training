...
Generated on: 2025-09-28T13:05:34.690111
...
python scripts/run_parallel_configs.py \
  ...
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_with_20250928-130534
cd ..
```
...
python scripts/run_parallel_configs.py \
  ...
  --num-variations 5 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_without_20250928-130534
cd ..
```
...
python scripts/run_parallel_configs.py \
  ...
  --num-variations 5 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_sft_without_20250928-130534
cd ..
```
...
python scripts/run_parallel_configs.py \
  ...
  --num-variations 5 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_dpo_without_20250928-130534
cd ..
```
...
- `model_comparison_results/llama_foundation_model_backstory_20250928-130534/`
