...
Generated on: 2025-09-29T16:18:03.766550
...
python scripts/run_parallel_configs.py \
  ...
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-161803
cd ..
```
...
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-161803 --output llama_foundation_model_backstory_gpt-4.1-mini_with_20250929-161803 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  --student-model gpt-4.1-mini \
  ...
  --num-variations 10 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_with_20250929-161803
cd ..
```
...
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-161803 --output llama_foundation_model_backstory_llama_sft_without_20250929-161803 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  ...
  --num-variations 10 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_sft_without_20250929-161803
cd ..
```
...
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-161803 --output llama_foundation_model_backstory_llama_dpo_without_20250929-161803 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  ...
  --num-variations 10 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_dpo_without_20250929-161803
cd ..
```
...
python get_judge_results.py \
  ...
  --folder-mapping '[{"llama_foundation_model_backstory_gpt-4.1-mini_without_20250929-161803": "gpt-4.1-mini (No Character)"}, {"llama_foundation_model_backstory_gpt-4.1-mini_with_20250929-161803": "gpt-4.1-mini (With Character)"}, {"llama_foundation_model_backstory_llama_sft_without_20250929-161803": "llama_sft (No Character)"}, {"llama_foundation_model_backstory_llama_dpo_without_20250929-161803": "llama_dpo (No Character)"}]' \
...
- `model_comparison_results/llama_foundation_model_backstory_20250929-161803/`
