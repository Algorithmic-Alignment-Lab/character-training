...
Generated on: 2025-09-28T21:25:17.683096
...
python scripts/run_parallel_configs.py \
  ...
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_without_20250928-212517
cd ..
```
...
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250928-212517 --output llama_foundation_model_backstory_gpt-4.1-mini_with_20250928-212517 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  --student-model gpt-4.1-mini \
  ...
  --num-variations 10 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_gpt-4.1-mini_with_20250928-212517
cd ..
```
...
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250928-212517 --output llama_foundation_model_backstory_llama_sft_without_20250928-212517 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  ...
  --num-variations 10 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_sft_without_20250928-212517
cd ..
```
...
cd ..
python copy_folders.py --input llama_foundation_model_backstory_gpt-4.1-mini_without_20250928-212517 --output llama_foundation_model_backstory_llama_dpo_without_20250928-212517 --replace
cd auto_eval_gen
python scripts/run_parallel_configs.py \
  --teacher-model claude-sonnet-4 \
  ...
  --num-variations 10 \
  --iterations-per-variation 1 \
  --timestamp llama_foundation_model_backstory_llama_dpo_without_20250928-212517
cd ..
```
...
- `model_comparison_results/llama_foundation_model_backstory_20250928-212517/`
