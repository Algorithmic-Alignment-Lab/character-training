...
Generated on: 2025-09-21T16:28:41.726969
...
python scripts/run_parallel_configs.py \
    ...
    --timestamp Base_20250921-162841 \
    --extra-evals
```
```bash
# Evaluate No_Versatile

cd .. && python copy_folders.py --input Base_20250921-162841 --output No_Versatile_20250921-162841 --replace && cd auto_eval_gen
...
python scripts/run_parallel_configs.py \
    ...
    --num-variations 3 \
    --iterations-per-variation 1 \
    --timestamp No_Versatile_20250921-162841 \
    --extra-evals
```
## Analysis Commands
...
python get_judge_results.py \
    ...
    --folder-mapping '[{"Base_20250921-162841": "Base"}, {"No_Versatile_20250921-162841": "No_Versatile"}]'
```
