...
Generated on: 2025-09-21T15:38:28.221280
...
python scripts/run_parallel_configs.py \
    ...
    --timestamp Base_20250921-153828 \
    --extra-evals
```
```bash
# Evaluate No_Versatile

cd .. && python copy_folders.py --input Base_20250921-153828 --output No_Versatile_20250921-153828 --replace && cd auto_eval_gen
...
python scripts/run_parallel_configs.py \
    ...
    --num-variations 10 \
    --iterations-per-variation 1 \
    --timestamp No_Versatile_20250921-153828 \
    --extra-evals
```
## Analysis Commands
...
python get_judge_results.py \
    ...
    --folder-mapping '[{"Base_20250921-153828": "Base"}, {"No_Versatile_20250921-153828": "No_Versatile"}]'
```
