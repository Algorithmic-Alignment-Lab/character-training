...
Generated on: 2025-09-21T15:02:52.579754
...
python scripts/run_parallel_configs.py \
    ...
    --timestamp Base_20250921-150252 \
    --extra-evals
```
```bash
# Evaluate No_Versatile

cd .. && python copy_folders.py --input Base_20250921-150252 --output No_Versatile_20250921-150252 --replace && cd auto_eval_gen
...
python scripts/run_parallel_configs.py \
    ...
    --num-variations 2 \
    --iterations-per-variation 1 \
    --timestamp No_Versatile_20250921-150252 \
    --extra-evals
```
## Analysis Commands
...
python get_judge_results.py \
    ...
    --folder-mapping '[{"Base_20250921-150252": "Gemini"}, {"No_Versatile_20250921-150252": "Gemini"}]'
```
