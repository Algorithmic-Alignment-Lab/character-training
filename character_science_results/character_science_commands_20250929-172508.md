...
Generated on: 2025-09-29T17:25:08.271252
...
```bash
# Evaluate No_Boundaries

python copy_folders.py --input Base_Rudi --output No_Boundaries --replace && cd auto_eval_gen

python scripts/run_parallel_configs.py \
    --teacher-model claude-sonnet-4 \
    --student-model gpt-4.1-mini \
    --character No_Boundaries \
    --character-full No_Boundaries \
    --num-workers 5 \
    --max-concurrent 10 \
    --num-variations 10 \
    --iterations-per-variation 1 \
    --timestamp No_Boundaries \
    --extra-evals
```
## Analysis Commands
...
python get_judge_results.py \
    ...
    --folder-mapping '{"Base_Rudi": "Base_Rudi", "No_Kindness": "No_Kindness", "No_Playfulness": "No_Playfulness", "No_Supportiveness": "No_Supportiveness", "No_Patience": "No_Patience", "No_Friendliness": "No_Friendliness", "No_Boundaries": "No_Boundaries"}'
```
