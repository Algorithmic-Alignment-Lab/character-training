...
Generated on: 2025-09-19T10:25:19.042288
...
python scripts/run_parallel_configs.py \
    ...
    --timestamp Base_20250919-102519 \
    --extra-evals
```
...
python scripts/run_parallel_configs.py \
    ...
    --num-variations 1 \
    --iterations-per-variation 1 \
    --timestamp No_Versatile_20250919-102519 \
    --extra-evals
```
...
python get_judge_results.py \
    ...
    --folder-mapping '[{"Base_20250919-102519": "Gemini"}, {"No_Versatile_20250919-102519": "Gemini"}]'
```
